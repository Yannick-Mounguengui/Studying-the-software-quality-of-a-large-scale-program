...
public final class GsonTest {
  ...
  @Test
  public void testUpperCaseFieldNamingStrategyDecorator() {
    // Create a Gson instance with UpperCaseFieldNamingStrategyDecorator
    Gson gson = new GsonBuilder()
            .setFieldNamingStrategy(new UpperCaseFieldNamingStrategyDecorator(FieldNamingPolicy.IDENTITY))
            .create();
    ...
    // Verify that the field names in the JSON are in uppercase
    assertTrue(json.contains("\"MYSTRING\":\"test\""));
    assertTrue(json.contains("\"MYINT\":123"));
  }
